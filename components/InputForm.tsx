...
const InputForm = ({ btnText }: InputFormProp) => {
    return (
        <form className='w-full flex flex-col gap-2 vs:gap-3 text-15px vs:text-base'>
            ...
            <button className='self-start bg-tertiary flex items-center gap-1 px-3 vs:px-4 py-2 mt-1 text-white rounded-3xl transition-bg duration-300 hover:bg-tertiarydark hover:shadow-first' type='submit'>
